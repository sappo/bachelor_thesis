...
\cite{gutmann10}
Nachdem in der Bedrohungsanalyse (\ref{chap:threat_analysis}) festgelegt wurde, gegen welche Bedrohungen beschützt werden soll und welche Maßnahmen dafür notwendig sind, ist der nächste Schritt die Bedrohungsmodellierung der Implementierung. Der Security Development Lifecycle (SDL) von Microsoft bietet für Modellierung einen einfachen Prozess, welcher schnell und leicht zu verstehen ist. Anhand von Data Flow Diagrammen (DFD) wird im folgenden Kapitel Modelliert. SDL entspringt keiner theoretischen akademischen Modell, es ist entstanden aus echten Problemen und gewachsen über Zeit. Zu beachten ist, dass die Bedrohungsmodellierung nur ein Teil des SDL-Prozesses ist.
