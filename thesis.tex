...
Anhand der Data Flow Diagramme werden Gefährdungen für Informationsflüsse gesucht. Diese werden zunächst einfachheitshalber in fünf Kategorien gegliedert werden, wobei der Denial of Service nicht berücksichtigt wird, da er zu universell ist:
...
In diesem Abschnitt werden die gefährdeten Informationen des Marktrechners mit Bezug auf die Authentifizierung und Autorisierung, identifiziert.
...
In Abbildung~\ref{fig:dfd_http} wird der Informationsfluss über das RestGateway gezeigt. Dabei fließen die Daten durch drei Vertrauensgrenzen. Sowohl RestGateway, als auch LanGateway fungieren hierbei als Datenproxy. Deswegen muss darauf geachtet werden, dass ein Angreifer über diese kein Datenwäsche durchführen kann.
