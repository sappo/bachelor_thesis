...
Der Benutzerknoten, in Auflistung~\ref{lst:ldif_user} ist im LDIF-Format dargestellt, erbt von zwei Objekt-Klassen. Der Distinguished Name (\textit{dn}) erlaubt es, einen Knoten eindeutig im Baum zu finden. Über die Objekt-Klasse \textit{person} wird verpflichtend das Attribut Common-Name (\textit{cn}) verfügbar, sowie weitere optionale Attribute für Vorname, Nachname, Benutzername und Passwort. Der Benutzername wird über \textit{uid} angegeben und spielt eine wichtige Rolle für die spätere FreeRADIUS-Konfiguration. Die Objekt-Klasse \textit{radiusProfile} ermöglicht das Hinzufügen von Rollen, die der FreeRADIUS-Server als \textit{radiusGroupName}-Attribute kennt und auslesen kann.
...
\begin{lstlisting}[caption=Inhalt im LDIF-Format, label=lst:ldap_content]
version: 1
...
#  radius Organisation
dn: ou=radius,dc=meinedomain,dc=local
objectClass: top
...
#  admins Organisation
dn: ou=admins,ou=radius,dc=meinedomain,dc=local
objectClass: top
objectClass: organizationalUnit
ou: people
ou: admins
...
dn: cn=binduser,ou=admins,ou=radius,dc=meinedomain,dc=local
objectClass: top
objectClass: person
cn: binduser
sn: freeradius
...
#  users Organisation
dn: ou=users,ou=radius,dc=meinedomain,dc=local
objectClass: top
objectClass: organizationalUnit
ou: radius
ou: users
...
dn: cn=John Doe+sn=Doe,ou=users,ou=radius,dc=meinedomain,dc=local
objectClass: top
objectClass: inetOrgPerson
objectClass: radiusProfile
objectClass: person
...
description: Master of the Universe
givenName: John
mail: j.doe@carrier.de
uid: jdoe
userPassword:: e3NoYX1mRXFOQ2NvM1lxOWg1WlVnbEQzQ1pKVDRsQnM9
radiusGroupName: fernservice

dn: cn=Matthias Wolf+sn=Wolf,ou=users,ou=radius,dc=meinedomain,dc=local
objectClass: top
objectClass: inetOrgPerson
objectClass: radiusProfile
objectClass: person
...
cn: Matthias Wolf
sn: Wolf
description: Second Master of the Universe
givenName: Matthias
