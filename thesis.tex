...
\centering
\includegraphics[width=6cm]{ssm.pdf}
\caption{Soft Systems Methodologie}
\label{fig:ssm}
\end{wrapfigure}
%\end{figure}

Das Bedrohungsmodell soll auf mögliche Gefahren des aktuellen Systems hinweisen und diese schrittweise, durch geeignete Maßnahmen, eindämmen. Eine geeignete Analyse- und Designmethodik dazu bietet die Soft Systems Methodology (SSM) in Abbildung~\ref{fig:ssm}. Besonderes Augenmerk findet die Trennung von Realer Welt und Systemmodell der Realen Welt. In der ersten Phase soll die gesamte Problemsituation aus Sicht aller Beteiligten erörtert und unstrukturiert beschrieben werden. Anschließend werden diese Informationen, der relevante Problembereich im Systemmodell der Realen Welt, aus Sicht eines Verteidigers und eines Angreifers beschrieben in jeweils einem konzeptionelles Modell beschrieben. Die Modelle werden zum Schluss gegeneinander und gegen die reale Welt verglichen. Die Vorgänge können wiederholt werden bis ein zufriedenstellendes Ergebnis erzielt wurde. Aus diesem wird dann eine Menge an Änderungen festgemacht, welche vorgenommen werden sollen.
