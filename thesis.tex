...
Ziel dieser Thesis ist es, eine Lösung zur Authentifizierung und Autorisierung zu schaffen. Abbildung~\ref{fig:uc_solution} zeigt die relevanten Use-Cases. Auf der linken Seite sind die Benutzer zu sehen, diese wollen lokalen oder entfernten bestimmte Funktionen auf dem Marktrechner aufrufen. Dazu müssen Sie vorher authentifiziert beziehungsweise autorisiert werden. Die Autorisierung basiert auf einem Rollenmodell, wobei ein Benutzer mehrere Rollen inne haben kann. Die Benutzung über den Reumotezugriff soll über HTTPS und das RestGateway des Marktrechners erfolgen. Zur Überprüfung der Authentifizierungs- und Autorisierungsdaten des Nutzers soll ein Authentifizierungs- und  Autorisierungs-Server (AAS) kontaktiert werden. Dieser AAS kann räumlich von den Benutzern, etwa über das Internet erreichbar sein. Der Marktrechner soll die Möglichkeit bieten mehrere AAS Anfragen zu können.
