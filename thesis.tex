...
\paragraph{Ökologische Einschränkungen} Die Kommunikation erfolgt verschlüsselt durch ein geeignetes Kryptoverfahren.  Der Zugriff auf alle Systeme ist durch entsprechende Berechtigungsnachweise geschützt.
...
Der erste Punkt kommt ist ebenfalls Teil des Konzeptionellen Modells der Beschützer, er wirkt sich auf beide Sichtweisen aus, allerdings ist er aus Angreifersicht positiv und aus Beschützersicht negativ anzusehen. Der Zweite Punkt zeigt, dass Angreifer nicht entdeckt werden wollen und zeigt eine Schwachstelle im Konzeptionellen Modell der Beschützer, da dort nicht explizit nach einem ausreichend, aussagekräftigen Logging-Mechanismus verlangt wird. Dadurch können viele Angriffe aufgedeckt werden. In Punkt drei versuchen die Angreifer in Besitz von Berechtigungsnachweisen zu kommen. Dazu gibt es mehrere Möglichkeiten, die zwei beliebtesten sind Phishing und Social Engineering. Damit ihre Zugriff auf das System trotz Logging legitim erscheinen. Daraus ergibt sich für die Beschützer nach Unregelmäßigkeiten in den aufgezeichneten Logs zu schauen, um dadurch kompromittierte Berechtigungsnachweise zu entdecken. In Punkt vier versuchen die Angreifer durch aufzeichnen und wieder einspielen von Nachrichten schaden anzurichten. Dies ist ein weiteres Kriterium, welches die Beschützer beim Nachrichtenaustausch beachten müssen. Insgesamt ergeben sich durch die Betrachtung aus Sicht der Angreifer drei gravierende Schwachstellen im Modell der Beschützer. Diese umformuliert in Beschützer sich ergeben folgende Ergänzungen: 
